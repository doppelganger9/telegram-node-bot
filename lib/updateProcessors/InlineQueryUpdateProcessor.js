...
class InlineQueryUpdateProcessor extends BaseUpdateProcessor {
    ...
    process(update) {
        ...
        var controller = this._dataSource.router.inlineQueryController
        ...
        if (update.inlineQuery) {
            ...
            try {
                controller.handle(controller.before(scope))
            }
            catch (e) {
        ...
        if (update.chosenInlineResult) {
            ...
            try {
                controller.chosenResult(update.chosenInlineResult)
            }
            catch (e) {
                this._dataSource.logger.error({
                    'error': e,
